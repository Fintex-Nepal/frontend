            ...
            <section class="max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md ">
                ...
                <form>
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-4">
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">User Name</label>
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Date Of Joining</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Degnation</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Is Pf Allowed</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Salary Posting Account</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                            value={userData?.salaryAmount}
                            />
                        </div>
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Provident Posting Account</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Tax</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                            value={userData?.tax}
                            readOnly
                            />
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Pan Number</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Grade</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Facilities</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">Other Facilities</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" 
                        ...
                        <div>
                            <label class="text-gray-700 dark:text-gray-200" for="passwordConfirmation">createdBy</label>
                            <input type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md   focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring"
