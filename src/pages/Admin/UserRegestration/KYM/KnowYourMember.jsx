    ...
    const onChangeHandler = (event) => {
        ...
        if (type === 'file') {
            ...
            if (name === 'ClientType' || name === "ShareType" || name === "ClientGroupId" || name === "ClientUnitId" || name === "KYMType" || name === "ClientMartialStatusCode") {
                ...
                // For IsShareAllowed field, convert the value to a boolean
                if (name === 'IsShareAllowed' || name === 'IsActive' || name === 'IsKYMUpdated') {
                    updatedClientInfo[name] = value === 'true';
                } else {
                    ...
                    <div class="flex items-center ">
                        <div class="flex items-center text-white relative">
                            <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2  border-teal-600 bg-teal-600">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="feather feather-bookmark ">
                        ...
                        <div class="flex items-center text-white relative">
                            <div class={`rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2  ${activeSteps > 2 ? 'bg-teal-600 border-teal-600' : 'bg-gray-600'}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" class="feather feather-mail ">
