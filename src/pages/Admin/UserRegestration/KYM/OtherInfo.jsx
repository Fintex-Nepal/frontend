...
const OtherInfo = () => {
  return (
    <div className='h-screen sm:flex'>
      {/* <div className=''> */}
        <section class="mt-7 max-w-7xl p-6 mx-auto bg-white rounded-md shadow-md sm:w-2/4 max-h-screen/2 overflow-y-scroll h-2/4 ">
      ...
      {/* </div> */}
      <div className='overflow-y-scroll flex-1 overflow-x-hidden max-w-7xl w-full'>
