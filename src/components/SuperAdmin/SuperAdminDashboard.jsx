                ...
                >
                    <div>
                        <div class="-mx-6 px-6 py-4">
                            <a href="1" title="home">
                                <img src={logo} class="w-32" alt="tailus logo" />
                            </a>
                        </div>
                                ...
                                <div class="h-full space-y-6 group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            stroke="url(1paint0_linear_622:13617)"
                                            stroke-width="10"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            ...
                                            stroke="url(1paint1_linear_622:13617)"
                                            stroke-width="10"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            ...
                                            stroke="url(1paint2_linear_622:13617)"
                                            stroke-width="10"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            d="M73 5.00001C86.6504 5.00001 99.9849 9.10831 111.269 16.7904"
                                            stroke="url(1paint3_linear_622:13617)"
                                            stroke-width="10"
                                            stroke-linecap="round"
                                        />
                                        <circle cx="73.5" cy="72.5" r="29" fill="1e4e4f2" stroke="1e4e4f2" />
                                        <path
                                        ...
                                        <defs>
                                            ...
                                            >
                                                <stop stop-color="1E323FF" />
                                                <stop offset="1" stop-color="17517F8" />
                                            </linearGradient>
                                            <linearGradient
                                                ...
                                                gradientUnits="userSpaceOnUse"
                                            >
                                                <stop stop-color="14DFFDF" />
                                                <stop offset="1" stop-color="14DA1FF" />
                                            </linearGradient>
                                            <linearGradient
                                                ...
                                                gradientUnits="userSpaceOnUse"
                                            >
                                                <stop stop-color="1FFD422" />
                                                <stop offset="1" stop-color="1FF7D05" />
                                            </linearGradient>
                                            <linearGradient
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <svg
                                                        ...
                                                        xmlns="http://www.w3.org/2000/svg"
                                                    >
                                                        <rect opacity="0.4" width="17" height="21" rx="1" fill="1e4e4f2" />
                                                        <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="1e4e4f2" />
                                                        <rect opacity="0.4" x="35" width="14" height="21" rx="1" fill="1e4e4f2" />
                                                        <rect opacity="0.4" x="51" width="17" height="21" rx="1" fill="1e4e4f2" />
                                                        <path
                                                            ...
                                                            stroke="url(1paint0_linear_622:13631)"
                                                            stroke-width="2"
                                                            stroke-linejoin="round"
                                                        />
                                                        <defs>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="url(1paint0_linear_622:13640)"
                                                            stroke-width="2"
                                                            stroke-linejoin="round"
                                                        />
                                                        <defs>
                                                            <linearGradient
                                                                ...
                                                                gradientUnits="userSpaceOnUse"
                                                            >
                                                                <stop stop-color="18AFF6C" />
                                                                <stop offset="1" stop-color="102C751" />
                                                            </linearGradient>
                                                        </defs>
                                                    </svg>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="url(1paint0_linear_622:13649)"
                                                            stroke-width="2"
                                                            stroke-linejoin="round"
                                                        />
                                                        <defs>
                                ...
                                <div class="h-full group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                                    ...
                                    >
                                        <path
                                            ...
                                            stroke="url(1paint0_linear_622:13664)"
                                            stroke-width="3"
                                            stroke-linecap="round"
                                        />
                                        <path
                                            ...
                                            stroke="url(1paint1_linear_622:13664)"
                                            stroke-width="3"
                                            stroke-linecap="round"
                                        />
                                        <defs>
                                ...
                                <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            stroke="url(1paint0_linear_622:13696)"
                                            stroke-width="5"
                                            stroke-linecap="round"
                                        />
                                        <path
