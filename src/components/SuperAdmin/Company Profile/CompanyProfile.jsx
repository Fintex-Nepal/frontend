   ...
   console.log(profileData,"profileDataprofileData");
    return (
        <>
            ...
            <div class="w-full sm:ml-48 ml-0 max-w-3xl overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <div class="px-6 py-4">
                    <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{profileData?.companyName}</h1>
                    ...
                    <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                        ...
                        <h1 class="px-2 text-sm">{profileData?.companyAddress}</h1>
                    </div>
                    ...
                    <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                        ...
                        <h1 class="px-2 text-sm">{profileData?.companyEmailAddress}</h1>
                    </div>
                </div>
            </div>
