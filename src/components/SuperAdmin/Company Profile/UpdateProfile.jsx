...
import { updatecompanyprofile } from '../../../utils/Url';
import Loader from '../../../utils/Helper/Loader'

const UpdateProfile = () => {
    const { id } = useParams()
    const [formData, setFormData] = useState({ id: Number(id), IsLogoChanged: false });
    ...
    const onSubmitHandler = (event) => {
        ...
        axios
            .put(updatecompanyprofile, formDataToSend, {
                headers: {
    ...
    return (
        <>
            ...
            <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md ">
                <h2 class="text-lg font-semibold text-gray-700 capitalize">Update Company Profile</h2>
