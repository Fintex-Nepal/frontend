      ...
      <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md ">
        ...
        <form onSubmit={onSubmitHandler}>
          <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label class="text-gray-700 ">Company Validity Start Date</label>
              <input type='date' onChange={onChangeHandler} name='CompanyValidityStartDate' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" />
            </div>
            <div>
              <label class="text-gray-700 ">Company Validity End Date</label>
              <input type='date' onChange={onChangeHandler} name='CompanyValidityEndDate' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" />
            </div>
            <div>
              <label class="text-gray-700 ">Current Tax</label>
              <input type='number' onChange={onChangeHandler} name='CurrentTax' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" />
            </div>
            <div>
              <label class="text-gray-700 ">Current  Fisical Year</label>
              <input type='string' onChange={onChangeHandler} name='CurrentFiscalYear' class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" />
            </div>
            <div>
              <label class="text-gray-700 ">Company Logo Date</label>
